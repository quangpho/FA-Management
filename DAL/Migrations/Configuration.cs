namespace DAL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DAL.FAMContext>
    {
        ...
        protected override void Seed(DAL.FAMContext context)
        {
				...
				List<TraineeCandidateProfile> lstProfile = new List<TraineeCandidateProfile>()
			{
				...
				List<StatusInClass> listStatusInClass = new List<StatusInClass>() {
				new StatusInClass() {StatusInClassName ="Waiting for Class" },
				new StatusInClass() {StatusInClassName ="Waiting for Allocation" },
				new StatusInClass() {StatusInClassName ="Deferred" },
				new StatusInClass() {StatusInClassName ="Drop-out" },
				new StatusInClass() {StatusInClassName ="Enrolled" },
				new StatusInClass() {StatusInClassName ="In-progress" },
				new StatusInClass() {StatusInClassName ="Active" }
			};
				context.StatusInClass.AddRange(listStatusInClass);
				context.SaveChanges();
